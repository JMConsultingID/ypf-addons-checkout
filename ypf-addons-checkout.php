...
function ypf_addons_rule_page(){
    ...
    <div class="wrap">
        ...
        <p>The feature you're trying to access is currently under active development. Our team is working diligently to enhance this functionality to ensure it meets our high standards of performance and user experience. While this feature is not yet available, we are making steady progress and are excited to bring it to you soon. Stay tuned for updates in upcoming releases, and we appreciate your patience and interest in our evolving product. For any inquiries or feedback regarding this feature, please feel free to contact our support team</p>
    </div>
    <?php
}
